...
if (!class_exists('MrAssistantSettings')) :
    /**
     * Class MrSettings
     */
    class MrAssistantSettings
    {
        ...
        public static function mrSections()
        {
            return array(
                ...
                array(
                    ...
                    'title' => __('Chat Appearance', 'mr-assistant')
                ),
                array(
                    'id' => 'mr_assistant_admin_appearance',
                    'title' => __('Admin Appearance', 'mr-assistant')
                ),
                array(
                ...
                array(
                    ...
                    'title' => __('Chat BOT', 'mr-assistant')
                ),
                array(
            ...
            return array(
                ...
                'mr_assistant_appearance_settings' => array(
                    array(
                        ...
                        'desc' => __('Choose your favourite theme type.', 'mr-assistant') . '<p><small>' . __('Note: you need to choose theme type as use color to use your custom color as theme.', 'mr-assistant') . '</small></p>',
                        'type' => 'radio',
                        'options' => array(
                            'theme' => 'Use Theme',
                ...
                'mr_assistant_admin_appearance' => array(
                    array(
                        ...
                        'desc' => __('Choose your favourite theme type for admin panel.', 'mr-assistant') . '<p><small>' . __('Note: you need to choose theme type as use color to use your custom color as theme.', 'mr-assistant') . '</small></p>',
                        'type' => 'radio',
                        'options' => array(
                            'theme' => 'Use Theme',
                            'color' => 'Use Custom Color'
                ...
                'mr_assistant_response' => array(
                    array(
                        ...
                        'desc' => __('This Intro message will appear on public facing chat widget when someone browsing your website.', 'mr-assistant'),
                    ...
                    array(
                        ...
                        'placeholder' => __('Write Message...', 'mr-assistant'),
                        'type' => 'text',
                    ...
                    array(
                        'name' => 'joinChat',
                        'label' => __('Join Chat Response', 'mr-assistant'),
                        'desc' => __('Set a response that will appear when operator join in chat room.', 'mr-assistant'),
                        'placeholder' => __('Hello, I\'m {operatorName}. It\'ll be just a moment while I review all the previous conversation.', 'mr-assistant'),
                        'type' => 'textarea',
                        'default' => 'Hello, I\'m {operatorName}. It\'ll be just a moment while I review all the previous conversation.',
                        'sanitize_callback' => 'sanitize_title'
                    ),
                    array(
                        'name' => 'gdpr_check',
                ...
                'mr_assistant_realtime_database' => array(
                    array(
                        'name' => 'email',
                        'label' => __('Project Email', 'mr-assistant'),
                        'desc' => __('Add Firebase project email address.', 'mr-assistant'),
                ...
                'mr_assistant_chatbot_settings' => array(
                    ...
                    array(
                        ...
                        'desc' => __('Virtual Assistant ICON will appear as chat bot ICON everywhere but not as chat bot menu ICON. You can add an image/icon URL from media library or different sources.', 'mr-assistant'),
                        'type' => 'file',
                        'default' => '',
                        'options' => array(
                            'button_label' => 'Browse ICON'
                    ...
                    array(
                        ...
                        'desc' => __('Virtual Assistant Menu ICON will appear only as chat bot menu ICON. You can add an image/icon URL from media library or different sources.', 'mr-assistant'),
                        'type' => 'file',
                        'default' => '',
                        'options' => array(
                            'button_label' => 'Browse ICON'
